# This Makefile is for the CGI::Lingua extension to perl.
#
...
#     NAME => q[CGI::Lingua]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::Requires=>q[0], Locale::Language=>q[0], Locale::Object::Country=>q[0], Data::Validate::IP=>q[0], I18N::AcceptLanguage=>q[0], Test::More=>q[0], I18N::LangTags::Detect=>q[0], Net::Whois::IP=>q[0], Net::Whois::IANA=>q[0] }
...
TO_INST_PM = lib/CGI/Lingua.pm

PM_TO_BLIB = lib/CGI/Lingua.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/CGI/Lingua.pm $(INST_MAN3DIR)/CGI::Lingua.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '    Data::Validate::IP:   0' >> META_new.yml
	$(NOECHO) $(ECHO) '    I18N::AcceptLanguage:  0' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="I18N::AcceptLanguage" />' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Test::Requires" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/CGI/Lingua.pm blib/lib/CGI/Lingua.pm 
